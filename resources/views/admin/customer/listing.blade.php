                        ...
                        <div class="min-w-full align-middle">
                            <table class="min-w-full border divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <th class="w-56 bg-gray-50 px-6 py-3 text-left">
                                        <span class="text-xs font-medium uppercase leading-4 tracking-wider text-gray-500">Confirmation Status</span>
                                    </th>
                                    <th class="w-56 bg-gray-50 px-6 py-3 text-left">
                                ...
                                @foreach($items as $item)
                                    <tr class="bg-white">
                                        ...
                                        <td class="px-6 py-4 text-sm leading-5 text-gray-900 whitespace-no-wrap">
                                            {{ $item->getConfirmationStatus() ? __('Confirmed') : __('Not confirmed') }}
                                        </td>
                                        <td class="px-6 py-4 text-sm leading-5 text-gray-900 whitespace-no-wrap">
                                            ...
                                            <form action="{{ route('admin.customer.delete', ['id' => $item->id]) }}" method="POST" onsubmit="return confirm('Are you sure?')" style="display: inline-block;">
                                                @csrf
                                                @method('DELETE')
                                                <x-danger-button>
                                                    Delete
